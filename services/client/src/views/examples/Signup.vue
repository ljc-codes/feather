                ...
                <div class="md-layout">
                  ...
                  >
                    <div class="social-line text-center">
                      <md-button class="md-just-icon md-round md-lg md-google">
                        <i class="fab fa-google" />
                      </md-button>
                      <spacer>....</spacer>
                      <md-button class="md-just-icon md-round md-lg md-linkedin">
                        <i class="fab fa-linkedin" />
                      </md-button>
                      <spacer>....</spacer>
                      <md-button class="md-just-icon md-round md-lg md-facebook">
                    ...
                    <form>
                      ...
                      <div class="button-container justify-content-center">
                        <md-button
                          ...
                          class="md-info md-lg md-round mt-3"
                        >
                          register
                        </md-button>
                      </div>
